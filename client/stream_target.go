...
type streamTarget interface {
	...
	beginResponse(ctx context.Context, rs respStream, release func(), status int, slab *[]byte, endedOnHeaders bool)
}
...
func (c *Client) beginStreaming(ctx context.Context, s protoStream, release func(), sendCut error, target streamTarget) error {
	...
	target.beginResponse(ctx, rs, release, status, ev.Slab, ev.EndStream)
	return nil
}
...
func (r *Response) beginResponse(ctx context.Context, rs respStream, release func(), status int, slab *[]byte, endedOnHeaders bool) {
	r.Status = status
	if slab != nil {
...
func (sr *StreamResponse) beginResponse(ctx context.Context, rs respStream, release func(), status int, slab *[]byte, endedOnHeaders bool) {
	sr.Status = status
	if slab != nil {
